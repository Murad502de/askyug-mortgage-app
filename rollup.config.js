...
export default {
  ...
  plugins: [
    ...
    replace({
      ...
      'process.env.VUE_APP_PAY_FORM_SWITCHER_ID': JSON.stringify(589157),
      'process.env.VUE_APP_PAY_FORM_MORTGAGE_ID': JSON.stringify(1262797),
      'process.env.VUE_APP_AMOCRM_SUBDOMAIN': JSON.stringify('usikuban'),
    }),
    jsonlint({
      mode: 'json',
      include: ["src/**/*.json"]
